	...
	;This licence will expire on Tue, 16 Oct 2012
	...
	; Compiler options:
	;
	; -o18lf46k80.cof -m18lf46k80.map --summary=default --output=default \
	; lab1_led.p1 --chip=18F46K80 -P --runtime=default --opt=default \
